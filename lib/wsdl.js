...
DefinitionsElement.prototype.addChild = function(child) {
    ...
    if (child instanceof TypesElement) {
		...
		// This assert is failing when wsdl:documentation is a child of wsdl:definitions.
		// Everything seems to be set up correctly for that relationship to work though.
